...
public class FileNameResolver implements IStreamFilenameGenerator {
	
   private static final Logger log = Red5LoggerFactory.getLogger(FileNameResolver.class, "StreamingServer");
